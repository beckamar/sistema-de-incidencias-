...
const AusenciaPersonalForm = ({opcionesAusencias, handleTipoAusenciasChange, tiposAusenciasError, useDescripcion, handleDescripcion, useClaveChange, handleClaveChange}) => {
    ...
    return (
        <div className="relative min-h-screen w-full flex flex-col">
            ...
            <main className="flex-1 flex flex-col items-center px-8 sm:px-6 md:px-10 pt-4 sm:pt-6 md:pt-8 pb-8">
                ...
                <form className="w-full max-w-xs sm:max-w-sm md:max-w-md pt-12 sm:pt-10 md:pt-12 flex-1 flex flex-col">
                    
                    <InstructionText label="Nombre completo"/>
                    <Input placeholder="Ejemplo: Ana Maria Perez Garcia" className={"mb-4 sm:mb-6 md:mb-8 lg:mb-10"}/>

                    <InstructionText label="RPE || RTT"/>
                    <Input value={useClaveChange} onChange={handleClaveChange} className={"mb-4 sm:mb-6 md:mb-8 lg:mb-10"}/>
                    ...
                    <InputText value={useDescripcion} onChange={handleDescripcion}/>
