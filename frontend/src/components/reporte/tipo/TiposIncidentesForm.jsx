...
const TiposIncidentesForm = ({opcionesIncidentes, handleTipoIncidenteChange, handleSubmitIncidente, handleBackLogin, error}) => {


    return(
        <div className="relative min-h-screen w-full flex flex-col">

            <Header onBack={handleBackLogin} label="Reporte"/>
            ...
            <main className="flex-1 flex flex-col items-center px-8 sm:px-6 md:px-10 pt-10 sm:pt-16 md:pt-40 pb-8">
                ...
                <form onSubmit={(e) => { e.preventDefault(); handleSubmitIncidente(); }} className="w-full max-w-xs sm:max-w-sm md:max-w-md pt-12 sm:pt-10 md:pt-12 flex-1 flex flex-col">
                    ...
                    <Button onClick={handleSubmitIncidente}>
                        SIGUIENTE
                    </Button>
