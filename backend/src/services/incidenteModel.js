...
export const getIncidentesService = async () =>  {
    ...
    CASE WHEN i.estado THEN 'Resuelto' ELSE 'Pendiente' END AS estado_incidente, 
    ...
    ORDER BY 
        i.estado ASC, 
        CASE WHEN i.estado = FALSE THEN i.fecha_reporte END ASC, 
        CASE WHEN i.estado = FALSE THEN i.hora_reporte END ASC, 
